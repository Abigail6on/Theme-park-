...
public class Experimentation4 {
    public static void main(String[] args) 	{
        ...
        int numTrain = 1;
        System.out.println("\t\t\t\t--------------------------------------");
        System.out.println("\t\t\t\tCase 4 - Alternate Logic/two Side Door");
        System.out.println("\t\t\t\t--------------------------------------");
        ...
        while (numTrain <= 8){
            ...
            while (true){
                for(i=0 ; i < NUMRUNS ; i++)
                {
                    thmPrk = new ThemeParks(startTime,endTime, true, 1, sds[i], numTrain, numCars,false);
