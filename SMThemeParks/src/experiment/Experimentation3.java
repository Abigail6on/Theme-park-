...
public class Experimentation3 {
    public static void main(String[] args) 	{
        ...
        int numTrain = 1;
        System.out.println("\t\t\t\t--------------------------------------");
        System.out.println("\t\t\t\tCase 3 - Alternate Logic/One Side Door");
        System.out.println("\t\t\t\t--------------------------------------");
        ...
        while (numTrain <= 8){
            ...
            while (true){
                for(i=0 ; i < NUMRUNS ; i++)
                {
                    thmPrk = new ThemeParks(startTime,endTime, true, 0, sds[i], numTrain, numCars,false);
                ...
                if(ciPercentType4.getPointEstimate() <= 2 &&
                    ...
                    System.out.print("PercentType1 = "+ciPercentType1.getPointEstimate() +" PercentType2 = "+ciPercentType2.getPointEstimate()+
                            ...
                            "\n Total Cost = $/day "+totalCost(numCars,numTrain,0));
                    numTrain++;
                    break;
                }
                else{
